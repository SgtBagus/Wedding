...
chart1.setOption(option = {
    backgroundColor: '#fff',
    color: [
        '#49C1B6', '#FDC20A', '#F78320', '#068E81', '#EA007B'
    ],
    tooltip: {
        trigger: 'axis',
        axisPointer: {
        ...
        formatter: function (params) {
            ...
            params.forEach(function (v, i, a) {
                if (v.data !== 0 && v.data !== "-" && v.seriesType == "line") {
                    rValue += '<span style="display:inline-block;margin-right:5px;border-radius:10px;width:9px;' +
                            'height:9px;background-color:' + v.color + '"></span>' + v.seriesName + ':' + v.data + '<br>';
                }
            })
            return rValue;
        }
...
media: [ // each rule of media query is defined here
    {
        ...
        option: {       // write options accordingly
            visualMap: {                   // legend is placed in middle-bottom
                right: 'center',
                bottom: 0,
...
var chart6 = echarts.init(document.getElementById('chart_6'));
...
var chart7 = echarts.init(document.getElementById('chart_7'));
...
var chart8 = echarts.init(document.getElementById('chart_8'));
...
var chart9 = echarts.init(document.getElementById('chart_9'));
chart9.setOption(option = {
    baseOption:{
    backgroundColor: '#403F4C',
    color: [
        '#D8973C', '#FFFFFF', '#64ea91'
    ],
...
var chart10 = echarts.init(document.getElementById('chart_10'));
...
var chart11 = echarts.init(document.getElementById('chart_11'));
var pathSymbols = {
    reindeer: 'path://M-22.788,24.521c2.08-0.986,3.611-3.905,4.984-5.892 c-2.686,2.782-5.047,5.' +
    ...
    plane: 'path://M1.112,32.559l2.998,1.205l-2.882,2.268l-2.215-0.012L1.112,32.559z M37.803' +
    ...
    rocket: 'path://M-244.396,44.399c0,0,0.47-2.931-2.427-6.512c2.819-8.221,3.21-15.709,3.21-' +
    ...
    train: 'path://M67.335,33.596L67.335,33.596c-0.002-1.39-1.153-3.183-3.328-4.218h-9.096v-' +
    ...
    ship: 'path://M16.678,17.086h9.854l-2.703,5.912c5.596,2.428,11.155,5.575,16.711,8.607c3' +
    ...
    car: 'path://M49.592,40.883c-0.053,0.354-0.139,0.697-0.268,0.963c-0.232,0.475-0.455,0.' +
    ...
    run: 'path://M13.676,32.955c0.919-0.031,1.843-0.008,2.767-0.008v0.007c0.827,0,1.659,0.' +
    ...
    walk: 'path://M29.902,23.275c1.86,0,3.368-1.506,3.368-3.365c0-1.859-1.508-3.365-3.368-3' +
...
var chart12 = echarts.init(document.getElementById('chart_12'));
...
var chart13 = echarts.init(document.getElementById('chart_13'));
...
var chart14 = echarts.init(document.getElementById('chart_14'));
var data = [];
for (var i = 0; i <= 200; i++) {
    var t = i / 10 * Math.PI;
...
var chart15 = echarts.init(document.getElementById('chart_15'));
chart15.setOption(option = {
    baseOption:{
    title: {
...
var chart16 = echarts.init(document.getElementById('chart_16'));
chart16.setOption(option = {
    baseOption:{
    backgroundColor: '#403F4C',
    title: {
        text: '',
...
var chart17 = echarts.init(document.getElementById('chart_17'));
...
var chart18 = echarts.init(document.getElementById('chart_18'));
var uploadedDataURL = "./plugins/echarts/charts/map/json/usa.json";
